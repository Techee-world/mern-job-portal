                  ...
                  >
                    <div className="flex justify-between items-center mb-3">
                      ...
                      <button
                        ...
                        className="bg-blue-500 hover:bg-slate-950 px-4 text-xs py-1 text-white rounded-lg"
                      >
                        Filter
                      </button>
                    </div>
                ...
                {jobListData.map((item) => (
                  <tbody>
                    <tr className="border-b dark:border-gray-700 relative">
                      ...
                      <td className="px-4 py-3">{item.maxExperience}</td>
                      <td className="px-4 py-3">{item.salaryRange}</td>
                      <td className="px-4 py-3 flex items-center justify-end">
                        ...
                        <div
                          ...
                          className={`${
                            isActiveMore ? "block" : "hidden"
                          } absolute top-11 right-0 z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600`}
                        >
                          <ul
                            className="py-1 text-sm text-gray-700 dark:text-gray-200"
