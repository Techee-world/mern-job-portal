...
const Favorite = () => {
 ...
 const jobList = useSelector(
   (state) => state.userFavoriteDataList.favoriteDataList
 );
 console.log(jobList,'aaaaaaaaaaa')
        ...
        <div key={index} className="border w-full p-4 mb-4 shadow-md">
          ...
          <div className="flex gap-4 items-center m-2">
            ...
            <div>
              ...
              <h4 className="  text-sm  rounded-sm">one</h4>
              <div className="flex mt-2 items-center gap-4">
                <h4 className="px-2 py-1 text-xs bg-gray-200 rounded-sm">
                  one
                </h4>
              </div>
              <p className="font-semi-bold text-xs mt-2">100 per Annual</p>
            </div>
          </div>
        </div>
        )}
